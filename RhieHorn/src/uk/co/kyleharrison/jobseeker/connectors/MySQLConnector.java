...
import uk.co.kyleharrison.jobseeker.model.YagaStruct;
...
public class MySQLConnector {
			...
			try{
				...
				try {
					...
					while(resultSet.next())
					{
						...
						job.setSalaryMinYearly(resultSet.getString("salaryMaxYearly"));
						...
						job.setAdvertiserName(resultSet.getString("advertiserName"));
						jobs.add(job);
					}
	...
	public String prepareStoredProcString(String table,String [] parameter){
		String sqlStatement ="INSERT INTO "+table+" (email_address,password) VALUES (";

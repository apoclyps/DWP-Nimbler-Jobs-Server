...
public class RequestController extends HttpServlet {
	...
	private void directToHome(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		HttpSession session = req.getSession();
		ApplicationSessionPojo currentUserSession = (ApplicationSessionPojo) session
				.getAttribute("Session");

		System.out.println("Accessed Server - Request controller");
